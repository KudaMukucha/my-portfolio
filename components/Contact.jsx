                ...
                {/**left */}
                    <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                        <div className='lg:p-4 h-full'>
                            <div>
                                <Image src={'/contact.jpg'} alt={'Contact Image'} width={400} height={400} className={'rounded-xl hover:scale-105 ease-in duration-300'}/>
                            </div>

                            <div className=''>
                                <h2 className='py-2'>Kuda Mukucha</h2>
                                <p>Front-end Developer</p>
                                <p className='py-4'>I am available for freelance or full time positions. Contact me and let's create something legendary.</p>
                            </div>
                            <div>
